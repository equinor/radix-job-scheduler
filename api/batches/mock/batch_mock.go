...
// Source: ./api/batches/batch_handler.go
...
func (m *MockBatchHandler) CreateBatch(batchScheduleDescription *models.BatchScheduleDescription) (*models.BatchStatus, error) {
	m.ctrl.T.Helper()
...
func (m *MockBatchHandler) GetBatch(batchName string) (*models.BatchStatus, error) {
	m.ctrl.T.Helper()
...
func (m *MockBatchHandler) GetBatches() ([]models.BatchStatus, error) {
	m.ctrl.T.Helper()
